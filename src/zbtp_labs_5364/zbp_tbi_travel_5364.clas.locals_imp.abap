...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    READ ENTITIES OF ztb_i_travel_5364 IN LOCAL MODE
    ENTITY Travel
...
*   Modify in local mode - BO - related updates there are not relevant for authorization objects
    MODIFY ENTITIES OF ztb_i_travel_5364 IN LOCAL MODE
    ENTITY Travel
...
*    REPORTED reported.
    ...
    DATA lt_create_travel TYPE TABLE FOR CREATE ztb_i_travel_5364\\Travel.

    SELECT MAX( travel_id ) FROM ztb_travel_5364 INTO @DATA(lv_travel_id).
...
*             last_changed_at )
  ...
  METHOD ValidateDates.
    ...
    READ ENTITY IN LOCAL MODE ztb_i_travel_5364\\Travel
...
CLASS lsc_ZTB_I_TRAVEL_5364 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PUBLIC SECTION.
...
CLASS lsc_ZTB_I_TRAVEL_5364 IMPLEMENTATION.

METHOD save_modified.

    DATA: lt_travel_log   TYPE STANDARD TABLE OF ztb_log_5364,
          lt_travel_log_u TYPE STANDARD TABLE OF ztb_log_5364.
    ...
    IF NOT create-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log>).
        ...
        <ls_travel_log>-changing_operation = lsc_ztb_i_travel_5364=>create.
    ...
    IF NOT update-travel IS INITIAL.
      ...
      LOOP AT update-travel INTO DATA(ls_update_travel).
        ...
        <ls_travel_log_db>-changing_operation = lsc_ztb_i_travel_5364=>update.
    ...
    IF NOT delete-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log_del>).
        ...
        <ls_travel_log_del>-changing_operation = lsc_ztb_i_travel_5364=>delete.
    ...
    IF NOT lt_travel_log_u IS INITIAL.
      INSERT ztb_log_5364 FROM TABLE @lt_travel_log_u.
    ENDIF.
