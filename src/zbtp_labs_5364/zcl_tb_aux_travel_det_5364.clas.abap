CLASS zcl_tb_aux_travel_det_5364 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED ztb_i_travel_5364,
           tt_booking_reported     TYPE TABLE FOR REPORTED ztb_i_booking_5364,
           tt_supplements_reported TYPE TABLE FOR REPORTED ztb_i_booksup_5364.
...
CLASS ZCL_TB_AUX_TRAVEL_DET_5364 IMPLEMENTATION.
  ...
  METHOD calculate_price.
   ...
   RESULT DATA(lt_read_supplements).
    ...
    GROUP BY ls_booking_supp-travel_id INTO lv_travel_key.
      ...
      GROUP BY ls_supplemets_result-currency_code INTO lv_curr.
